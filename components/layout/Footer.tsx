...
export function Footer() {
  ...
  const whatsappUrl = supportNumber
    ? getWhatsAppUrl(supportNumber, "Hola, necesito ayuda con EstateElevate.")
    : "#";
  ...
  return (
    <footer className="bg-slate-950 text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* Top row */}
        <div className="py-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-slate-800">
          <div>
          ...
          <div className="flex items-center gap-4">
            {supportNumber && (
              <a
                ...
                className={cn(
                  "inline-flex items-center gap-2 px-4 py-3 min-h-[44px] rounded-lg text-sm font-medium",
