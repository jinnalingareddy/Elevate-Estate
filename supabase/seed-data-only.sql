-- ============================================================
-- EstateElevate — Data-only seed  (NO auth.users insert)
-- Run this AFTER users already exist in Supabase Auth.
--
-- Prerequisites:
--   Create these users first via Dashboard → Auth → Users
--   OR run the TypeScript seeder (npx tsx seed-test-data.ts)
--
--   Emails (password: TestPassword123!):
--     carlos.garcia@estateelevate.mx
--     maria.lopez@estateelevate.mx
--     juan.martinez@estateelevate.mx
--     paula.sanchez@estateelevate.mx
--     roberto.hernandez@estateelevate.mx
--     lucia.gonzalez@estateelevate.mx
--     fernando.torres@estateelevate.mx
--     claudia.ramirez@estateelevate.mx
--     admin@estateelevate.mx          (password: AdminPassword123!)
--     test.buyer@estateelevate.mx
-- ============================================================

-- ----------------------------------------------------------------
-- 1. PROFILES — update the auto-created rows with full details
--    (handle_new_user trigger created bare rows on signup)
-- ----------------------------------------------------------------
UPDATE public.profiles SET phone='5255100000001', role='agent', agency_name='Premier Inmobiliario',
  bio='Especialista en propiedades de lujo en la CDMX con más de 10 años de experiencia.',
  verified=true, plan='pro'    WHERE email='carlos.garcia@estateelevate.mx';

UPDATE public.profiles SET phone='5255100000002', role='agent', agency_name='Luxury Homes México',
  bio='Agente certificada en bienes raíces residenciales y comerciales.',
  verified=true, plan='elite'  WHERE email='maria.lopez@estateelevate.mx';

UPDATE public.profiles SET phone='5255100000003', role='agent', agency_name='Elite Properties',
  bio='Más de 15 años conectando familias con su hogar ideal.',
  verified=true, plan='pro'    WHERE email='juan.martinez@estateelevate.mx';

UPDATE public.profiles SET phone='5255100000004', role='agent', agency_name='Realty Group Internacional',
  bio='Experta en desarrollos inmobiliarios en zonas turísticas.',
  verified=true, plan='elite'  WHERE email='paula.sanchez@estateelevate.mx';

UPDATE public.profiles SET phone='5255100000005', role='agent', agency_name='Casa Elegante',
  bio='Especialista en propiedades residenciales en Monterrey.',
  verified=true, plan='free'   WHERE email='roberto.hernandez@estateelevate.mx';

UPDATE public.profiles SET phone='5255100000006', role='agent', agency_name='Propiedades del Futuro',
  bio='Innovadora en el mercado inmobiliario con enfoque digital.',
  verified=true, plan='pro'    WHERE email='lucia.gonzalez@estateelevate.mx';

UPDATE public.profiles SET phone='5255100000007', role='agent', agency_name='Inmobiliaria Central',
  bio='Asesor inmobiliario con amplia cartera en el Bajío.',
  verified=false, plan='free'  WHERE email='fernando.torres@estateelevate.mx';

UPDATE public.profiles SET phone='5255100000008', role='agent', agency_name='Top Tier Real Estate',
  bio='Propiedades premium en Guadalajara y Zapopan.',
  verified=true, plan='elite'  WHERE email='claudia.ramirez@estateelevate.mx';

UPDATE public.profiles SET phone='5255100000009', role='admin', verified=true, plan='elite'
  WHERE email='admin@estateelevate.mx';

UPDATE public.profiles SET phone='5255200000001', role='buyer', verified=true, plan='free'
  WHERE email='test.buyer@estateelevate.mx';

-- Verify all profiles updated
SELECT email, role, plan, verified FROM public.profiles ORDER BY role, email;
...
-- ----------------------------------------------------------------
-- 3. LISTINGS  (agent_id resolved by email — no UUID needed)
-- ----------------------------------------------------------------
...
((SELECT id FROM public.profiles WHERE email='carlos.garcia@estateelevate.mx'),
 ...
 'Espectacular residencia en la exclusiva colonia Polanco. Acabados de primera calidad, jardín privado y alberca.',
 ...
 '[{"public_id":"https://images.unsplash.com/photo-1600585154340-be6161a56a0c","thumbnail_url":"https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=400","medium_url":"https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800","large_url":"https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1600"}]',
 142,2018),
...
((SELECT id FROM public.profiles WHERE email='maria.lopez@estateelevate.mx'),
 ...
 'Moderno departamento con vista panorámica a Santa Fe. Amenidades de lujo: gimnasio, spa y concierge 24 hrs.',
 ...
 '[{"public_id":"https://images.unsplash.com/photo-1560448204-e02f11c3d0e2","thumbnail_url":"https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=400","medium_url":"https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800","large_url":"https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=1600"}]',
 89,2022),
...
((SELECT id FROM public.profiles WHERE email='juan.martinez@estateelevate.mx'),
 ...
 'Casa remodelada en Roma Norte. Tres niveles, rooftop con jacuzzi y sistema de domótica completo.',
 ...
 '[{"public_id":"https://images.unsplash.com/photo-1512917774080-9991f1c4c750","thumbnail_url":"https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=400","medium_url":"https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800","large_url":"https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=1600"}]',
 213,2010),
...
((SELECT id FROM public.profiles WHERE email='paula.sanchez@estateelevate.mx'),
 ...
 'Penthouse frente al mar Caribe con vista de 360°. Alberca infinity y acabados importados.',
 ...
 '[{"public_id":"https://images.unsplash.com/photo-1499793983690-e29da59ef1c2","thumbnail_url":"https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?w=400","medium_url":"https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?w=800","large_url":"https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?w=1600"}]',
 312,2020),
...
((SELECT id FROM public.profiles WHERE email='roberto.hernandez@estateelevate.mx'),
 ...
 'Residencia en Cumbres Elite con sistema solar y jardín zen.',
 ...
 '[{"public_id":"https://images.unsplash.com/photo-1568605114967-8130f3a36994","thumbnail_url":"https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=400","medium_url":"https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=800","large_url":"https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=1600"}]',
 178,2021),
...
((SELECT id FROM public.profiles WHERE email='claudia.ramirez@estateelevate.mx'),
 ...
 'Loft de diseño con techos altos y terraza privada en la colonia más bohemia de Guadalajara.',
 ...
 '[{"public_id":"https://images.unsplash.com/photo-1502672260266-1c1ef2d93688","thumbnail_url":"https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=400","medium_url":"https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800","large_url":"https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=1600"}]',
 67,2023),
...
((SELECT id FROM public.profiles WHERE email='lucia.gonzalez@estateelevate.mx'),
 ...
 '[{"public_id":"https://images.unsplash.com/photo-1500382017468-9049fed747ef","thumbnail_url":"https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=400","medium_url":"https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800","large_url":"https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=1600"}]',
 45,null),

-- 8 · COMMERCIAL · Masaryk Polanco
((SELECT id FROM public.profiles WHERE email='carlos.garcia@estateelevate.mx'),
 'Local Comercial Premium en Presidente Masaryk','local-comercial-premium-masaryk',
 'Local en planta baja sobre Presidente Masaryk. Alto tráfico peatonal, fachada de 8 m.',
 ...
 '[{"public_id":"https://images.unsplash.com/photo-1441986300917-64674bd600d8","thumbnail_url":"https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=400","medium_url":"https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=800","large_url":"https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1600"}]',
 93,2015),

-- 9 · CONDO · Playa del Carmen · pending
((SELECT id FROM public.profiles WHERE email='paula.sanchez@estateelevate.mx'),
 'Condominio Frente al Mar Playa del Carmen','condominio-frente-mar-playa-del-carmen',
 'Condominio a 50 metros de la playa. Alberca comunitaria y seguridad 24h.',
 ...
 '[{"public_id":"https://images.unsplash.com/photo-1510414842594-a61c69b5ae57","thumbnail_url":"https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?w=400","medium_url":"https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?w=800","large_url":"https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?w=1600"}]',
 55,2019),

-- 10 · HOUSE · San Ángel · draft
((SELECT id FROM public.profiles WHERE email='juan.martinez@estateelevate.mx'),
...
SELECT l.id,md5('ip-001'),now()-interval'2 days'  FROM public.listings l WHERE slug='casa-de-lujo-en-polanco'          UNION ALL
SELECT l.id,md5('ip-002'),now()-interval'1 day'   FROM public.listings l WHERE slug='casa-de-lujo-en-polanco'          UNION ALL
SELECT l.id,md5('ip-003'),now()-interval'3 hours' FROM public.listings l WHERE slug='departamento-moderno-santa-fe'    UNION ALL
SELECT l.id,md5('ip-004'),now()-interval'5 hours' FROM public.listings l WHERE slug='villa-contemporanea-roma-norte'   UNION ALL
SELECT l.id,md5('ip-005'),now()-interval'1 hour'  FROM public.listings l WHERE slug='penthouse-lujo-zona-hotelera-cancun' UNION ALL
SELECT l.id,md5('ip-006'),now()-interval'30 min'  FROM public.listings l WHERE slug='villa-moderna-cumbres-monterrey'
...
((SELECT id FROM public.listings WHERE slug='casa-de-lujo-en-polanco'),
 ...
 'Me interesa agendar una visita. ¿Tienen disponibilidad este fin de semana?','new',false,'listing_page'),
...
((SELECT id FROM public.listings WHERE slug='departamento-moderno-santa-fe'),
 ...
 'Busco un departamento en Santa Fe. ¿Es negociable el precio?','contacted',true,'search_results'),

((SELECT id FROM public.listings WHERE slug='villa-contemporanea-roma-norte'),
 (SELECT id FROM public.profiles WHERE email='juan.martinez@estateelevate.mx'),
 'Valentina Cruz','vcruz@empresa.com','5255300000003',
 'Tenemos pre-aprobación bancaria por 6 millones. Queremos visitar con arquitecto.','qualified',true,'referral'),
...
((SELECT id FROM public.listings WHERE slug='penthouse-lujo-zona-hotelera-cancun'),
 ...
 'Ofrezco 5.2 millones de contado, cierre en 30 días.','negotiating',true,'listing_page'),
...
((SELECT id FROM public.listings WHERE slug='villa-moderna-cumbres-monterrey'),
 ...
 'Proceso ya concluido. Gracias por su apoyo.','closed',true,'direct'),
...
((SELECT id FROM public.listings WHERE slug='local-comercial-premium-masaryk'),
 ...
 'Interesado en el local para restaurante japonés.','new',false,'google_ads')
ON CONFLICT DO NOTHING;
...
-- 7. SUPPORT TICKETS
-- ----------------------------------------------------------------
INSERT INTO public.support_tickets (user_id, email, subject, message, status, priority) VALUES
((SELECT id FROM public.profiles WHERE email='fernando.torres@estateelevate.mx'),
 'fernando.torres@estateelevate.mx',
 'No puedo subir fotos a mi propiedad',
 'Intento cargar imágenes pero el botón no responde. Uso Chrome en Windows 11.',
 'open','high'),
((SELECT id FROM public.profiles WHERE email='roberto.hernandez@estateelevate.mx'),
 'roberto.hernandez@estateelevate.mx',
 ...
 'in_progress','medium'),
(null,'anonimo@gmail.com',
 'Propiedad con información incorrecta',
 'La propiedad en Polanco dice 4 recámaras pero tiene 3.',
 'open','urgent')
ON CONFLICT DO NOTHING;
