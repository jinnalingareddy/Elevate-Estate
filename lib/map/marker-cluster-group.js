// Local vendor copy of react-leaflet-cluster/lib/index.js
// CSS imports (lines 31-32 of the original) are removed here because
// turbopack cannot instantiate CSS module factories from CJS node_modules.
// The two CSS files are imported globally via app/globals.css instead.
"use strict";
...
// CSS removed — loaded globally via app/globals.css
delete leaflet_1.default.Icon.Default.prototype._getIconUrl;
leaflet_1.default.Icon.Default.mergeOptions({
    iconRetinaUrl: require('react-leaflet-cluster/lib/assets/marker-icon-2x.png').default,
    iconUrl: require('react-leaflet-cluster/lib/assets/marker-icon.png').default,
    shadowUrl: require('react-leaflet-cluster/lib/assets/marker-shadow.png').default,
});
